...
Outre son interface de monitoring, Marvel propose aussi Sense (http://localhost:9200/_plugin/marvel/sense/), , qui permet de requêter ElasticSearch dans son browser.
